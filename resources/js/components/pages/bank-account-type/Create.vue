<template>
  <app-card :title="edit ? 'Edit ' + form.title : 'Add New <b>Bank Account Type</b>'">
    <!-- <template #actions>
        ...
        <div class="col-sm-9 col-md-10">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Bank Account Type Attributes</h4> 
                     <table>
                    <thead>
                        <tr>
                            <th>SN</th>
  ...
  methods: {
    ...
    async updateData() {
      try {
        ...
        this.$router.push({ name: 'bankAccountType.list', params: { bank: this.form.bank }, });
      } catch (error) {
        console.log(error);
    ...
    async getData() {
      ...
      let { bank, title, slug, image, display, description, accountType, attributes } = data.data;
    ...
    async getAccountTypes() {
      let accountTypes = await this.accountTypeModel.getAll('bank');
