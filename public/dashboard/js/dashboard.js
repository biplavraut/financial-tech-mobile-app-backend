(function ($) {
    ...
    $(function () {
        ...
        if ($("#north-america-chart-dark").length) {
            ...
            document.getElementById("north-america-legend-dark").innerHTML =
                northAmericaChartDark.generateLegend();
        }
        ...
        if ($("#south-america-chart-dark").length) {
            ...
            document.getElementById("south-america-legend-dark").innerHTML =
                southAmericaChartDark.generateLegend();
        }
    });
})(jQuery);
